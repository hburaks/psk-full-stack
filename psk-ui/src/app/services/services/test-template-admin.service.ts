...
import { getAvailableTestTemplatesForUser } from '../fn/test-template-admin/get-available-test-templates-for-user';
import { GetAvailableTestTemplatesForUser$Params } from '../fn/test-template-admin/get-available-test-templates-for-user';
...
import { updateTestTemplateQuestions } from '../fn/test-template-admin/update-test-template-questions';
import { UpdateTestTemplateQuestions$Params } from '../fn/test-template-admin/update-test-template-questions';
import { uploadImage } from '../fn/test-template-admin/upload-image';
import { UploadImage$Params } from '../fn/test-template-admin/upload-image';
...
export class TestTemplateAdminService extends BaseService {
  ...
  /** Path part for operation `updateTestTemplateQuestions()` */
  static readonly UpdateTestTemplateQuestionsPath = '/v2/admin/test-templates/{id}/questions';

  /**
   * Update test template questions.
   *
   * Update all questions and choices for a test template
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `updateTestTemplateQuestions()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  updateTestTemplateQuestions$Response(params: UpdateTestTemplateQuestions$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<QuestionResponse>>> {
    return updateTestTemplateQuestions(this.http, this.rootUrl, params, context);
  }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `updateTestTemplateQuestions$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  updateTestTemplateQuestions(params: UpdateTestTemplateQuestions$Params, context?: HttpContext): Observable<Array<QuestionResponse>> {
    return this.updateTestTemplateQuestions$Response(params, context).pipe(
      map((r: StrictHttpResponse<Array<QuestionResponse>>): Array<QuestionResponse> => r.body)
    );
  }
